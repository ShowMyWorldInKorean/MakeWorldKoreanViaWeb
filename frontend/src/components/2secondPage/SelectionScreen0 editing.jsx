...
function SelectionScreen() {
  ...
  return (
    ...
    <section className="flex flex-col mr-5 grow text-center text-black max-md:mt-10 max-md:max-w-full">
 
 <h1 className="my-3
  text-4xl font-semibold text-center text-black">
          번역을 원하는 부분을 모두 선택해주세요
        </h1>
      <section className="flex flex-col pt-5 pb-7 mt-9 mb-3.5 w-full bg-white border-solid border-[0.7px] border-[color:var(--Neutral-color-Neutral-300,#D6D6D6)] max-w-[1282px] rounded-[30px] max-md:max-w-full">
